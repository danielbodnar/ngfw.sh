...
import { setupMockServer, mockFetch } from '../utils/test-utils';
import { devices, natRules, mockToken } from '../fixtures';
...
describe('API Client Integration', () => {
  ...
  describe('Error Handling', () => {
    it('throws ApiError on 404', async () => {
      ...
      await expect(error404Api.getDeviceStatus('invalid-id')).rejects.toThrow(ApiError);
      await expect(error404Api.getDeviceStatus('invalid-id')).rejects.toThrow('Device not found');
    });
