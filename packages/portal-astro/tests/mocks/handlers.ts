...
export const handlers = [
  ...
  http.put(`${API_BASE}/routing/routes/:routeId`, async ({ params, request }) => {
    const body = await request.json();
  ...
  http.post(`${API_BASE}/vpn/server/peers`, async ({ request }) => {
    const body = await request.json();
    return HttpResponse.json({ ...vpnServerPeers[0], ...body }, { status: 201 });
  }),
  ...
  http.post(`${API_BASE}/vpn/client/profiles`, async ({ request }) => {
    const body = await request.json();
    return HttpResponse.json({ ...vpnClientProfiles[0], ...body }, { status: 201 });
  }),

  http.put(`${API_BASE}/vpn/client/profiles/:profileId`, async ({ params, request }) => {
    const body = await request.json();
  ...
  http.get(`${API_BASE}/vpn/client/profiles/:profileId/status`, ({ params }) => {
  ...
  http.put(`${API_BASE}/ddns/configs/:configId`, async ({ params, request }) => {
    const body = await request.json();
  ...
  http.post(`${API_BASE}/reports`, async ({ request }) => {
    const body = await request.json();
    return HttpResponse.json({ ...reports[0], ...body, status: 'pending' }, { status: 201 });
  }),
  ...
  http.put(`${API_BASE}/dashboards/:dashboardId`, async ({ params, request }) => {
    const body = await request.json();
