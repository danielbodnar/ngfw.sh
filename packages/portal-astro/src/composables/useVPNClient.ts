...
export function useVPNClient(
		...
		try {
			...
			error.value =
				err instanceof Error
					? err.message
					: "Failed to fetch VPN client profiles";
		} finally {
			loading.value = false;
		}
	}
	...
	async function create(
		...
		try {
			...
			error.value =
				err instanceof Error ? err.message : "Failed to create VPN profile";
			throw err;
		}
	}
	...
	async function update(
		...
		try {
			...
			error.value =
				err instanceof Error ? err.message : "Failed to update VPN profile";
			throw err;
		}
	}
	...
	async function remove(profileId: string): Promise<void> {
		...
		try {
			...
			error.value =
				err instanceof Error ? err.message : "Failed to delete VPN profile";
			throw err;
		}
	}
	...
	async function getStatus(profileId: string): Promise<VPNClientStatus> {
		...
		try {
			...
			error.value =
				err instanceof Error ? err.message : "Failed to get VPN status";
			throw err;
		}
	}
	...
	async function connect(profileId: string): Promise<void> {
		...
		try {
			...
			error.value =
				err instanceof Error ? err.message : "Failed to connect VPN";
			throw err;
		}
	}
	...
	async function disconnect(profileId: string): Promise<void> {
		...
		try {
			...
			error.value =
				err instanceof Error ? err.message : "Failed to disconnect VPN";
			throw err;
		}
	}
