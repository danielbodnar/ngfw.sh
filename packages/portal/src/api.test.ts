...
import { createApiClient, ApiError, type Device, type DeviceRegistrationResponse, type DeviceStatus } from './api';
  ...
  describe('deleteDevice', () => {
    ...
    it('should throw ApiError on 403 Forbidden', async () => {
      ...
      vi.mocked(globalThis.fetch).mockResolvedValue({
        ...
        json: async () => ({ error: 'Cannot delete device owned by another user' }),
      } as Response);
