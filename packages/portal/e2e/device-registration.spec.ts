...
test.describe('Device Registration', () => {
  ...
  test('should successfully register device with name and model', async ({ page }) => {
    await page.click('button:has-text("Register Device")');
    ...
    await expect(page.locator('[data-testid="api-key"]')).toContainText('test-api-key-123456');
