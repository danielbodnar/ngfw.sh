...
const openapi = fromHono(app, {
	...
	schema: {
		info: {
			...
			version: "1.0.0",
			description:
				"Next-generation firewall management API for router configuration, monitoring, and fleet management.",
			contact: {
		...
		tags: [
			...
			{
				name: "Routing",
				description: "Static routes and policy-based routing",
			},
			...
			{
				name: "IPS",
				description: "Intrusion prevention system configuration and alerts",
			},
