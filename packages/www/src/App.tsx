...
const features = [
	{
		...
		description:
			"Deep packet inspection with application-aware filtering. Block threats before they enter your network.",
		color: "emerald",
	},
	{
		icon: Filter,
		title: "DNS Filtering",
		description:
			"Block ads, trackers, and malware at the DNS level. Protect every device without installing software.",
		color: "cyan",
	},
	{
		icon: Lock,
		title: "WireGuard VPN",
		description:
			"Secure remote access with the fastest VPN protocol. Connect from anywhere with zero configuration.",
		color: "violet",
	},
	{
		icon: Eye,
		...
		description:
			"AI-powered threat detection identifies and blocks attacks in real-time. Stay ahead of emerging threats.",
		color: "amber",
	},
	{
		icon: BarChart3,
		...
		description:
			"Complete visibility into your network. See who is using bandwidth and what applications are running.",
		color: "blue",
	},
	{
		icon: Users,
		...
		description:
			"Manage multiple sites from a single dashboard. Perfect for businesses with distributed networks.",
		color: "rose",
	},
];
...
export default function App() {
	...
	return (
		<div className="min-h-screen bg-zinc-950 text-zinc-100">
					...
					<div className="flex items-center justify-between h-16">
						...
						<div className="hidden md:flex items-center gap-3">
							<Button
								variant="ghost"
								onClick={() => {
									window.location.href = "https://app.ngfw.sh";
								}}
							>
								Sign In
							</Button>
			...
			<section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
				<div className="max-w-7xl mx-auto text-center">
					...
					<p className="text-lg sm:text-xl text-zinc-400 max-w-2xl mx-auto mb-10">
						Next-generation firewall protection for your home or business. Block
						threats, filter content, and secure remote access - all from a
						beautiful dashboard.
					</p>
				...
				<div className="max-w-7xl mx-auto">
					<div className="text-center mb-16">
						...
						<p className="text-zinc-400 max-w-2xl mx-auto">
							Professional-grade security tools that are easy to use. No
							networking degree required.
						</p>
					</div>
			...
			<section
				id="pricing"
				className="py-24 px-4 sm:px-6 lg:px-8 bg-zinc-900/30"
			>
				<div className="max-w-7xl mx-auto">
					<div className="text-center mb-12">
						...
						<p className="text-zinc-400 max-w-2xl mx-auto mb-8">
							Professional network security starting at $25/mo. All plans
			...
			<section id="hardware" className="py-24 px-4 sm:px-6 lg:px-8">
				<div className="max-w-7xl mx-auto">
					<div className="text-center mb-16">
						...
						<p className="text-zinc-400 max-w-2xl mx-auto">
							Our routers include all the processing power needed for deep
							packet inspection, VPN, and threat detection without slowing down
							your network.
						</p>
					</div>
			...
			<section className="py-24 px-4 sm:px-6 lg:px-8">
				<div className="max-w-4xl mx-auto text-center">
					...
					<p className="text-zinc-400 mb-8">
						Join thousands of users who trust NGFW.sh to protect their homes and
						businesses.
					</p>
					<div className="flex flex-col sm:flex-row items-center justify-center gap-4">
						<Button
