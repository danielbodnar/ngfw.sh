...
describe('API<->Agent WebSocket Protocol Integration', () => {
  ...
  describe('Status Updates', () => {
    ...
    it('should track multiple status updates', async () => {
      const statuses = [
        { online: true, uptime: 1000, firmware_version: '388.1_0', wan_connected: true },
        { online: true, uptime: 2000, firmware_version: '388.1_0', wan_connected: true },
        { online: true, uptime: 3000, firmware_version: '388.1_0', wan_connected: true },
      ];
