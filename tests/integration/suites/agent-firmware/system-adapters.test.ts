...
describe('Agent<->Firmware System Adapters Integration', () => {
  ...
  describe('IPTables Adapter', () => {
    it('should add firewall rules', () => {
      const result = firmware.executeCommand('iptables -A INPUT -p tcp --dport 22 -j ACCEPT');
  ...
  describe('Dnsmasq Adapter', () => {
    ...
    it('should manage DHCP leases', () => {
      firmware.dnsmasq.addLease('00:11:22:33:44:55', '192.168.1.100', 'client1', Date.now() + 3600000);
      firmware.dnsmasq.addLease('00:11:22:33:44:56', '192.168.1.101', 'client2', Date.now() + 3600000);
