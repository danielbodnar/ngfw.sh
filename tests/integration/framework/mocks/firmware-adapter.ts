...
export class MockDnsmasq {
  ...
  private leases = new Map<string, { ip: string; mac: string; hostname: string; expires: number }>();
  ...
  getLeases(): Array<{ ip: string; mac: string; hostname: string; expires: number }> {
...
export class MockWireless {
  private interfaces = new Map<string, {
    ssid: string;
    enabled: boolean;
    channel: number;
    security: string;
  ...
  setInterface(name: string, config: {
    ssid: string;
    enabled: boolean;
    channel: number;
    security: string;
...
export class MockFirmwareAdapter {
  ...
  private commandHistory: Array<{ command: string; result: CommandResult; timestamp: Date }> = [];
   ...
   */
  getCommandHistory(): Array<{ command: string; result: CommandResult; timestamp: Date }> {
 ...
 */
export function createMockFirmwareAdapter(config?: FirmwareAdapterConfig): MockFirmwareAdapter {
